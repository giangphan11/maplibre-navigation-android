...
import com.mapbox.mapboxsdk.style.layers.PropertyFactory.circlePitchAlignment
...
import com.mapbox.mapboxsdk.style.layers.PropertyFactory.circleStrokeOpacity
...
import com.mapbox.services.android.navigation.testapp.helpers.inMeters
import com.mapbox.services.android.navigation.testapp.helpers.isApril1st
import com.mapbox.services.android.navigation.testapp.helpers.maplibre.clear
import com.mapbox.services.android.navigation.testapp.helpers.maplibre.toLatLon
import com.mapbox.services.android.navigation.testapp.helpers.maplibre.toPoint
import com.mapbox.services.android.navigation.testapp.helpers.normalizeLongitude

/** Takes care of showing the location + direction + accuracy marker on the map */
class CurrentLocationMapComponent(context: Context, mapStyle: Style, private val map: MapboxMap) :
